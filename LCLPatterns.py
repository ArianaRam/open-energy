# -*- coding: utf-8 -*-
"""
Created on Wed Mar 10 10:22:35 2021
...
pred_y= kmeans.fit_predict(LCLHfull.T)    #here you input your clean dataset
...
Pattern.index= LCLHfull.index

#%% [4] Visualize your results 

# Full year view
plt.plot(Pattern)
plt.title('Energy Consumption Patterns 2013')
plt.xlabel('Month')
...
date1= '2013-03-05 00:00:00'
date2= '2013-03-05 23:30:00'

March5= Period(Pattern, date1, date2)

M5full= Period(Hfull, date1, date2)
...
ax.set(xlabel="Hour", ylabel="kWh/hh")
ax.set(title="Energy Consumption per Cluster");
ax.xaxis.set_major_formatter(myFmt); 

#%%[8] visualize hfull day

myFmt = DateFormatter('%H:%M') 
fig, ax = plt.subplots(figsize = (12,4))
ax.plot(M5full) 
ax.set(xlabel="Hour", ylabel="kWh/hh")
ax.set(title="Energy Consumption Full Set")
#ax.set_ylim([-0.5, 1.75])
ax.xaxis.set_major_formatter(myFmt); 

#%%[9] Select array function 
...
f.suptitle('LCL Representative Consumer Clusters', size=14)
...
#%%[11] Run elbow function 

wcss, cents, labels, n_iter= elbow(Hfull)

#will take more than 45 mins on a standart laptop

#%%[12] #%% [12] Visualize elbow
